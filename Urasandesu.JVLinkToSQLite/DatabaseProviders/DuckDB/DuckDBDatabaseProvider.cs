...
namespace Urasandesu.JVLinkToSQLite.DatabaseProviders.DuckDB
{
    ...
    public class DuckDBDatabaseProvider : IDatabaseProvider
    {
        ...
        public DuckDBDatabaseProvider(string connectionString)
        {
            ...
            _connectionFactory = new DuckDBConnectionFactory();
            _sqlGenerator = new DuckDBSqlGenerator();
        }
        ...
        public bool IsConnected => false; // DuckDB doesn't maintain persistent connections
        ...
        protected virtual void Dispose(bool disposing)
        {
            if (!_disposed)
            {
                if (disposing)
                {
                    // DuckDB doesn't require explicit cleanup for the provider itself
